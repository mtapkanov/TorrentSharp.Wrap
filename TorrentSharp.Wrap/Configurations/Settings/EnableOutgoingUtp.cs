...
/// </summary>
public sealed record EnableOutgoingUtp(bool Value) : ISettingsEntry<EnableOutgoingUtp>
{
    public static string Key => "enable_outgoing_utp";
    public static EnableOutgoingUtp FromValue(object value) => new((bool)value);
    object ISettingsEntry<EnableOutgoingUtp>.Value => Value;
}
