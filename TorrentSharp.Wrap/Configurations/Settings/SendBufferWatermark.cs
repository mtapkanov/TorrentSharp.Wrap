...
/// </summary>
public sealed record SendBufferWatermark(int Value) : ISettingsEntry<SendBufferWatermark>
{
    public static string Key => "send_buffer_watermark";
    public static SendBufferWatermark FromValue(object value) => new((int)value);
    object ISettingsEntry<SendBufferWatermark>.Value => Value;
}
