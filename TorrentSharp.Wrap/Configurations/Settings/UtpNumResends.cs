...
/// as fast.
/// </summary>
public sealed record UtpNumResends(int Value) : ISettingsEntry<UtpNumResends>
{
    public static string Key => "utp_num_resends";
    public static UtpNumResends FromValue(object value) => new((int)value);
    object ISettingsEntry<UtpNumResends>.Value => Value;
}
