...
/// as fast.
/// </summary>
public sealed record UtpGainFactor(int Value) : ISettingsEntry<UtpGainFactor>
{
    public static string Key => "utp_gain_factor";
    public static UtpGainFactor FromValue(object value) => new((int)value);
    object ISettingsEntry<UtpGainFactor>.Value => Value;
}
