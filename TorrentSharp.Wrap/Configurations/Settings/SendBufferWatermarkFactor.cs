...
/// </summary>
public sealed record SendBufferWatermarkFactor(int Value) : ISettingsEntry<SendBufferWatermarkFactor>
{
    public static string Key => "send_buffer_watermark_factor";
    public static SendBufferWatermarkFactor FromValue(object value) => new((int)value);
    object ISettingsEntry<SendBufferWatermarkFactor>.Value => Value;
}
