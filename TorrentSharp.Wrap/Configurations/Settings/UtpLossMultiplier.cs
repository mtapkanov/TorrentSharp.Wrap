...
/// as fast.
/// </summary>
public sealed record UtpLossMultiplier(int Value) : ISettingsEntry<UtpLossMultiplier>
{
    public static string Key => "utp_loss_multiplier";
    public static UtpLossMultiplier FromValue(object value) => new((int)value);
    object ISettingsEntry<UtpLossMultiplier>.Value => Value;
}
