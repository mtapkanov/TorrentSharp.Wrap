...
/// </summary>
public sealed record PeerTurnoverCutoff(int Value) : ISettingsEntry<PeerTurnoverCutoff>
{
    public static string Key => "peer_turnover_cutoff";
    public static PeerTurnoverCutoff FromValue(object value) => new((int)value);
    object ISettingsEntry<PeerTurnoverCutoff>.Value => Value;
}
