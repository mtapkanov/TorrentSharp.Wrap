...
/// </summary>
public sealed record SeedTimeRatioLimit(int Value) : ISettingsEntry<SeedTimeRatioLimit>
{
    public static string Key => "seed_time_ratio_limit";
    public static SeedTimeRatioLimit FromValue(object value) => new((int)value);
    object ISettingsEntry<SeedTimeRatioLimit>.Value => Value;
}
