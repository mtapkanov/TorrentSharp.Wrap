...
/// </summary>
public sealed record ActiveDownloads(int Value) : ISettingsEntry<ActiveDownloads>
{
    public static string Key => "active_downloads";
    public static ActiveDownloads FromValue(object value) => new((int)value);
    object ISettingsEntry<ActiveDownloads>.Value => Value;
}
