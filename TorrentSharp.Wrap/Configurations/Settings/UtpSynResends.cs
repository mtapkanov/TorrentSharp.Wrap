...
/// as fast.
/// </summary>
public sealed record UtpSynResends(int Value) : ISettingsEntry<UtpSynResends>
{
    public static string Key => "utp_syn_resends";
    public static UtpSynResends FromValue(object value) => new((int)value);
    object ISettingsEntry<UtpSynResends>.Value => Value;
}
