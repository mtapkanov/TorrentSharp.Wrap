...
/// </summary>
public sealed record PeerTurnover(int Value) : ISettingsEntry<PeerTurnover>
{
    public static string Key => "peer_turnover";
    public static PeerTurnover FromValue(object value) => new((int)value);
    object ISettingsEntry<PeerTurnover>.Value => Value;
}
