...
/// </summary>
public sealed record I2pInboundQuantity(int Value) : ISettingsEntry<I2pInboundQuantity>
{
    public static string Key => "i2p_inbound_quantity";
    public static I2pInboundQuantity FromValue(object value) => new((int)value);
    object ISettingsEntry<I2pInboundQuantity>.Value => Value;
}
