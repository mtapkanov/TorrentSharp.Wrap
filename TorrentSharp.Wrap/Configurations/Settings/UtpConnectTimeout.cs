...
/// as fast.
/// </summary>
public sealed record UtpConnectTimeout(int Value) : ISettingsEntry<UtpConnectTimeout>
{
    public static string Key => "utp_connect_timeout";
    public static UtpConnectTimeout FromValue(object value) => new((int)value);
    object ISettingsEntry<UtpConnectTimeout>.Value => Value;
}
