...
/// as fast.
/// </summary>
public sealed record UtpFinResends(int Value) : ISettingsEntry<UtpFinResends>
{
    public static string Key => "utp_fin_resends";
    public static UtpFinResends FromValue(object value) => new((int)value);
    object ISettingsEntry<UtpFinResends>.Value => Value;
}
